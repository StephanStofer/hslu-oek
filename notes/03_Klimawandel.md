...
## Merkmale von Klimaveränderungen
...
* El Niño/Sudliche Oszillation (ENSO) - erstreckt sich über Südpazifik mit Periodizität von 3 bis 8 Jahren
...
Ist die wichtigste aller Oszillationen. Als Gegenpart names La Niña mit entgegengesetzten Effekten. Wichtigste Indikatoren des El Niño

* Anstieg des Luftdrucks über dem indischen Ozean
* Gleichzeitig Druckabfall über Mittel- und Ostpazifik
* Tropische Passatwinde schwächen ab oder drehen ihre Richtung
...
Der Multivariante El Niño Index (MEI) ist ein Ansazu zur Messung des ENSO. Globaltemperatur und MEI korrelieren stark miteinander. Ausnahmen sind Jahre mit grossen Vulkanausbrüchen.
...
### Treibhauseffekt
Leben auf der Erde beruht auf dem natürlichen Treibhauseffekt, ohne wäre es zu kalt. Seit der industriellen Revolution deutlicher Anstieg von $CO_2$, $CH_4$ und $N_2O$ Gehalt in der unteren Atmosphäre. Zunahme vorallem auf Landwirtschaft, Abholzung udn Verbrennung fossiler Brennstoffe zurückzuführen. Messungen von $CO_2$ und $CH4$ in Kernbohrungen von Gletschereis weisen auf eine hohe Korrelation zwischen Konzentrationsniveau ....
Der Anstieg des $CO_2$-Niveau verdoppelte sich beinahe in den letzten 300 Jahren. Die $CO_2$-Emissionen weiterhin mit der aktuellen Rate von etwa 3.3% pro Jahr ansteigen. Das Niveau soll nicht über 450 ppm sollte vermieden werden. Ist geschätzer Kipppunkt, der massive Klimaveränderung in gang setzten könnte. Idealerweise erreichen wir eine Reduktion von $CO_2$ auf 350 ppm, was dem vorindustriellen Niveau entspricht. Das Klima der Erde könnte sich stabilisieren.
...
Beschreibt die mögliche Auswikrungen jedes Treibhausgases. Einige Gase haben grösseren Einfluss auf die Erwärmung der Atmosphäre als andere. Wichtigste Eigenschaften in Bezug auf die Klimawirkung sind:

* Energieabsorptions-Potential (verhinder, dass Energie in Weltraum entweicht)
* Verweilzeit von Gas in der Atmosphäre

Das Treibhausgaspotential misst die Gesamtenergie, im Vergleich zu $CO_2$ über einen Zeitraum von 100 Jahren absorbiert. 60% der Methanemissionen sind während der letzten 275 Jahre entstanden. Stickstoffoxid hat sich während der selben Zeitspanne um ~20% erhöht.

![Treibhauspotential der THG](notes/images/treibhauspotential-im-vergleich.png)

Merkmale für das Treibhauspotential ist der Faktor wie das Gas mehr Wärme zurückhalt. Schlimmstes intensivstes Gas in Stickstoffoxid.
...
~30% des landgebundenen Pflanzen- und Tierarten könnten aussterben wenn die globale durchschnittliche Temperaturänderung 1.5-2.5 C° übersteigt. Anteil könnte bis auf 70% ansteigen wenn Temperatur auf 2.5C° steigt. Die Erwärmung beeinflusst auch die biologische Uhr von Vögeln, Walen und anderen Wandertiere -> Migration zu flaschen Orten und Zeiten. Ökosysteme brechen zusammen (Korallenriffe, Polarmeere) und Arten werden aussterben.
